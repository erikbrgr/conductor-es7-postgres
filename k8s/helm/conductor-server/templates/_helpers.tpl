...
helm.sh/chart: {{ include "conductor-server.chart" . }}
{{ include "conductor-server.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
*/}}
{{- define "conductor-server.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "conductor-server.fullname" .) .Values.serviceAccount.name }}
{{- else }}
